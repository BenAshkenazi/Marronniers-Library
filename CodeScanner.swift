...
struct ScannerView: View{
        @State public var check = endCode
    ...
    var body: some View{
        ...
        Text(check)
            /*if let x = endCode{
        NavigationLink(destination: LinkView(linkButton:  LinkButton(id: 666, title: endCode!, link: endCode!))) {
            Text(endCode!)}*/
...
public struct CodeScannerView: UIViewControllerRepresentable {
    ...
    public class ScannerCoordinator: NSObject, AVCaptureMetadataOutputObjectsDelegate {
        ...
        {
            self.codesFound = Set<String>()
            print(self.codesFound, "codes found")
    ...
    public class ScannerViewController: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate{
        ...
        override public func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
            ...
            print("simulatedData", simulatedData)
        ...
        public func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]){
            if let qrcodeImg = info[.originalImage] as? UIImage {
                ...
                if qrCodeLink=="" {
                    ...
                    print("imagePickerController", qrCodeLink)
    ...
    public init(codeTypes: [AVMetadataObject.ObjectType], scanMode: ScanMode = .continuous, showViewfinder: Bool = false, scanInterval: Double = 2.0, simulatedData: String = "", completion: @escaping (Result<String, ScanError>) -> Void) {
